...
function closeTutorial() {
  ...
  // Zet startbedrag en maandelijks bedrag op 0
...
function updateBudget() {
  ...
  // Na de tutorial geldt: maandbedrag = inkomsten - uitgaven
...
document.addEventListener("DOMContentLoaded", () => {
  ...
  // Vul de dropdown voor looptijd met opties van 1 tot 50 jaar, standaard op 20 jaar
